...
urlpatterns = [
    ...
    path('product-sales-summary', views.product_sales_summary, name='product_sales_summary'),
    path('customer-sales-summary', views.customer_sales_summary, name='customer_sales_summary'),
